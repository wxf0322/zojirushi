    ...
    <div class="login-box-body">
        ...
        <form id="login" action="/login" method="post">
            <div class="form-group has-feedback">
                <input id="loginName" name="loginName" type="loginName" class="form-control" placeholder="用户名" value="${loginName}">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input id="password" name="password" type="password" class="form-control" placeholder="密码" value="${password}">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input id="rememberMe" name="rememberMe" type="checkbox" value="false"> 记住我
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <div class="block"><span style="color: #FF0000;">${result.msg}</span></div>
        <a href="#">登录遇到问题?</a><br>
